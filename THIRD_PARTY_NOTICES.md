...
The image uses Debian's `default-jre-headless` OpenJDK runtime. OpenJDK is
licensed under GPLv2 with the Classpath Exception; Debian package notices remain
available under `/usr/share/doc` in the image.
